export const arabic = {
	...
	to: "ل",
	from: "من",
	"Minimum purchase": "  أدنى مبلغ للشراء ",
	"Maximum discount": " أقصى خصم",
	Chat: "محادثة",
	"Sender or Receiver location is missing": " موقع المرسل أو المستلم مفقود  ",
	...
	"insufficient amount": " المبلغ غير كافٍ ",
	...
	Login: "تسجيل الدخول",
	"Want to login to your services ?": "هل ترغب في تسجيل الدخول إلى خدماتك؟",
	"Login here": "سجل الدخول هنا",
	Dashboard: "لوحة التحكم ",
	"Collect Cash": "جمع النقود ",
	"Open Confirm Dialog": "افتح نافذة التأكيد ",
	"Confirm this request ? ": "تأكيد الطلب؟",
	Cancel: "إلغاء",
	Yes: "نعم",
	Download: "تحميل",
	Filter: "تصفية",
	...
	"Go Back Home": "ارجع الى الرئيسية",
	...
	"Most Popular Items": "أكثر المنتجات شهرة ",
	"View all": "عرض الكل",
	"New On Quick": "جديد على كـويـك",
	"Popular Restaurants ": "المطاعم الشهيرة",
	"Popular Food Nearby": " الطعام الشهير بالقرب منك ",
	Nearby: "بالقرب",
	...
	"Expired on": " انتهى في",
	Purchase: "شراء",
	"Min purchase": "أدنى مبلغ للشراء ",
	"Only for": "فقط ل",
	"Only for some specific zones": "مخصص لبعض المناطق المحددة فقط   ",
	Restaurant: "مطعم",
	Max: "الأعلى",
	Code: "شفرة",
	...
	" I agree that placing the order places me under Terms and Conditions & Privacy Policies":
		" أوافق على أن تقديم الطلب يُخضعني للشروط والأحكام وسياسات الخصوصية.",
	...
	"Contact Person Number": "رقم شخص المسؤول",
	"Street Number": "رقم الشارع",
	...
	"Convert your loyalty point to wallet money.":
		"حوّل نقاط الولاء الخاصة بك إلى رصيد في المحفظة",
	...
	"Item added to cart": "  تم إضافة العنصر إلى السلة ",
	...
	"Highlights for you": " أبرز المميزات لك",
	"Search your desired foods ": " ابحث عن الأطعمة التي ترغب بها  ",
	"File upload": "تحميل الملف",
	"See our most popular restaurant and foods":
		" شاهد أفضل مطاعمنا وأطعمتنا الأكثر شهرة",
	"Delivery Man Type": " تصنيف مندوب التوصيل  ",
	Zone: "منطقة",
	...
	Logo: "شعار",
	Items: "المنتجات",
	"items for you !": "منتجات من أجلك!",
	"Store for you !": " متجر من أجلك!",
	items: "المنتجات",
	"Coupon Applied": "تم تفعيل القسيمة ",
	Paid: "مدفوع",
	Unpaid: "غير مدفوع ",
	"order-summary": " ملخص الطلب",
	"Order Summary": "ملخص الطلب ",
	"Your food will be delivered within": "سيتم توصيل طعامك خلال   ",
	"Back to home": "الرجوع إلى الصفحة الرئيسية ",
	"Order Place Failed": "فشل في تقديم الطلب  ",
	"Order didn't place successfully.": "لم يتم تقديم الطلب بنجاح.",
	"Are you sure you want to cancel this order?":
		"هل أنت متأكد أنك تريد إلغاء هذا الطلب؟",
	"Popular in this Restaurant!": "الأكثر شهرة في هذا المطعم!",
	"Delivery man doesnt assigned": " لم يتم تعيين مندوب التوصيل ",
	"Delivery man has not been assigned": "لم يتم تعيين مندوب التوصيل ",
	"Not Available now": "غير متوفر الآن",
	"Available will be": "سيتوفر ",
	"non-veg": " غير نباتي",
	veg: "نباتي",
	"All Products": "جميع المنتجات",
	"Positive Review": "تقييم إيجابية",
	"Delivering to": "تسليم إلى",
	Recommended: "مُستَحسَن",
	"Cash On Delivery": "الدفع عند الاستلام",
	"Switch to cash on delivery": "التحويل إلى الدفع عند الاستلام    ",
	"Are you sure you want to switch this order to Cash On Delivery?":
		" هل أنت متأكد أنك تريد تحويل هذا الطلب إلى الدفع عند الاستلام؟  ",
	...
	wallet: "محفظة",
	" Change": "تغيير",
	"Added to favorite successfully.": "تمت إضافته إلى المفضلة بنجاح.",
	...
	"If you log in, your order history will be saved. However, if you continue as a guest, you won't be able to see your order history after completing your order.":
		"إذا قمت بتسجيل الدخول، سيتم حفظ سجل طلباتك. أما إذا تابعت كضيف، فلن تتمكن من رؤية سجل طلباتك بعد إتمام طلبك .",
	...
	"You have food from another restaurant in cart. If you continue, your all previous food from cart will be removed":
		"لديك طعام من مطعم آخر في السلة. إذا واصلت، سيتم إزالة جميع العناصر السابقة من السلة",
	...
	"You denied location permission. Please allow browsers location permission from your device, refresh the site and receive more accurate delivery.":
		"لقد قمت برفض إذن الموقع. يرجى السماح بإذن الموقع في المتصفح من جهازك، ثم تحديث الموقع للحصول على توصيل أكثر دقة",
	Variation: "اختلاف",
	Addon: "اضافه",
	"You place the order successfully.": " تم تقديم الطلب بنجاح",
	"Your order is placed Successfully. We start our delivery process and you will receive your food soon":
		"تم تقديم طلبك بنجاح. بدأنا عملية التوصيل وستتلقى طعامك قريبًا",
	"Congratulations!": "تهانينا!",
	"One or more item is not available for the chosen preferable schedule time.":
		"إحدى العناصر أو أكثر غير متوفرة في الوقت المحدد المفضل",
	...
	"Communicate with our support team to get proper guidance to your quaternaries.":
		"تواصل مع فريق الدعم لدينا للحصول على الإرشادات المناسبة لاستفساراتك.",
	"VISIT US": "زورنا",
	...
	"Please search a location first.": "يرجى البحث عن الموقع أولا.",
	"New location has been set.": "تم تعيين موقع جديد.",
	"Popular Foods Nearby": "الأطعمة الشهيرة بالقرب منك",
	"Please exchange more than": "يرجى استبدال أكثر من",
	points: "نقاط",
	...
	"Refer your code to your friends and get":
		"شارك رمزك مع أصدقائك واحصل على",
	...
	"Please give an amount": "يرجى تحديد المبلغ  ",
	referrer: "المرجع",
	"Open Your Own Virtual Restaurant On": " افتح مطعمك الافتراضي الخاص على ",
	"Join as delivery man on": "انضم كمندوب توصيل على   ",
	"Lets Connect !": " لنتمكن من التواصل!",
	"Stay upto date with restaurants and foods around you":
		" ابقَ على اطلاع بأحدث المطاعم والأطعمة حولك  ",
	...
	"Days Since Joining": "الأيام منذ الانضمام",
	...
	"This variation is out of stock": "هذا الخيار غير متوفر في المخزون   ",
	"Free delivery": "توصيل مجاني",
	"Store is closed. Try again later.":
		" المتجر مغلق. حاول مرة أخرى لاحقًا",
	"Restaurant is closed. Try again later.":
		"المطعم مغلق. حاول مرة أخرى لاحقًا.",
	...
	"Subscribe to our weekly newsletter and be a part of our journey to self discovery and love.":
		"اشترك في النشرة الإخبارية الأسبوعية الخاصة بنا وكن جزءًا من رحلتنا    .",
	"Join Us!": "انضم إلينا!",
	"Recent Searches": "عمليات البحث الحديثة",
	"Quick View": "نظرة سريعة",
	"Visit Store": "قم بزيارةالمتجر",
	...
	"Remove it form my cart": "إزالته من عربة التسوق الخاصة بي ",
	"I will wait until it is restocked": "سأنتظر حتى يتم إعادة تخزينه",
	"Please cancel the order": "يرجى إلغاء الطلب  ",
	"Call me ASAP": "الاتصال بي في اسرع وقت ممكن",
	"Fresh Item that deserve to eat": " منتج طازج يستحق أن يُؤكل ",
